...
class PositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create position" do
    assert_difference('Position.count') do
      post positions_url, params: { position: { code: @position.code, description: @position.description } }
    end
  ...
  test "should update position" do
    patch position_url(@position), params: { position: { code: @position.code, description: @position.description } }
